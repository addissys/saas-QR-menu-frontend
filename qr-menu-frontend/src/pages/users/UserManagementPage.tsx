...
export const UserManagementPage: React.FC = () => {
  ...
  const resetForm = () => {
    ...
    setRoleId(availableRoles[0]?.id ?? ''); setBranchId(''); setFormErrors({});
    setBranchIds([]);
  };
